...
<head>
    ...
    <link rel="stylesheet" href="../../Responsive_css/sidebar.css">
...
<!-- 
                    ...
                    <div class="login-form text-center p-4 " >
                        ...
                        <form action="" class="">
                            ...
                            <div class="mb-3 form-box d-flex align-items-center p-2">
                                ...
                                <input type="text" name="" id="admin_otp" placeholder="OTP">
                            </div>

                            <div class="d-grid mb-3">
                                <input type="submit" value="Verify Email" class="btn login-btn " id="admin_otpbtn">
                            </div>
    ...
    <script src="admin_js.js?<?php time(); ?>"></script>
