...
<!-- 
                    ...
                    <div class="login-form text-center p-4  ">
                        <h4 class="mb-4">Reseller Sign Up</h4>

                        <form action="" autocomplete="off" id="Reseller_RegisterDetails">
                            ...
                            <div class="mb-3 form-box d-flex align-items-center p-2">
                                ...
                                <input type="text" name="Rs_register_name" id="Reseller_name" placeholder="Enter Your Full Name" >
                            </div>

                            <div class="mb-3 form-box d-flex align-items-center p-2">
                                <i class="fa-solid fa-envelope fs-4 mx-2"></i>
                                <input type="text" name="Rs_register_email" id="Reseller_email" placeholder="Enter Your Email">
                            </div>

                            <div class="mb-3 d-flex justify-content-around fs-5">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="Rs_register_gender" id="flexRadioDefault1" checked value="Male">
                                    <label class="form-check-label" for="flexRadioDefault1" >
                                      Male
                                    </label>
                                  </div>
                                  <div class="form-check">
                                    <input class="form-check-input" type="radio" name="Rs_register_gender" id="flexRadioDefault2" value="Female">
                            ...
                            <div class="mb-3 form-box password-eye showpassword d-flex align-items-center p-2">
                                ...
                                <input type="password" name="Rs_register_password" id="Reseller_password" placeholder="Enter Your 
Password">
                            ...
                            <div class="mb-3 form-box password-eye confirmPassword d-flex align-items-center p-2">
                                <i class="fa-solid fa-lock fs-4 mx-2"></i>
                                <input type="password" name="" id="ResellerConfirm_password" placeholder="Confirm Password">
                                <i class="fa-regular fa-eye eye"></i>
                                <i class="fa-solid fa-eye-slash eye d-none"></i>
                            </div>

                            <div class="d-grid">
                                <input type="submit" value="Sign Up" class="btn login-btn " id="Reseller_submitbtn">
                            </div>
                        </form>
    ...
    <script src="homepage javascript/reseller_register.js?<?=time();?>"></script>
